...
export default function main(testDataFile = 'testData.txt') { //eslint-disable-line no-multiple-empty-lines
  /* TODO
    ...
    3. 将所有计费结果拼接并使用\n分割，然后保存到receipt变量中。
   */
  const receipt = ShowTaxiValuation.showPrice(testDataFile);
  console.log(receipt);
  return receipt;
}
